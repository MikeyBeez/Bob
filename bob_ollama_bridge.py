...
3. For file reading, use: {{"tool_call": true, "tool_name": "filesystem_read", "parameters": {{"path": "file_path"}}}}
4. For git status, use: {{"tool_call": true, "tool_name": "git_status", "parameters": {{"path": "repo_path"}}}}
5. For bullshit detection, use: {{"tool_call": true, "tool_name": "detect_bullshit", "parameters": {{"text": "text_to_analyze"}}}}
6. For project finding, use: {{"tool_call": true, "tool_name": "find_project", "parameters": {{"name": "project_name"}}}}
7. For cognitive processing, use: {{"tool_call": true, "tool_name": "cognitive_process", "parameters": {{"content": "content_to_process", "mode": "analysis"}}}}
